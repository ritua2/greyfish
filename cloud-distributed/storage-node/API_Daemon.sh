...
if [ $1 == "-up" ]; then 
  #gunicorn -w $greyfish_threads --certfile=certfile.crt --keyfile=keyfile.key -b 0.0.0.0:3443 traffic:app &
  gunicorn -w $greyfish_threads -b 0.0.0.0:3443 traffic:app &
